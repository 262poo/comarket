...
<table>
  <tr>
    <td colspan="7">Unidad 2: Aplicaciones de escritorio con interfaz gráfica y persistencia de datos</td>
  </tr>
  <tr>
    <td colspan="4">Resultado de aprendizaje</td>
    <td colspan="3">Producto</td>
...
<table>
  <tr>
    <td colspan="7">Unidad 3: Proyecto Integrador de Aplicación de Escritorio</td>
  </tr>
  <tr>
    <td colspan="4">Resultado de aprendizaje</td>
    <td colspan="3">Producto</td>
...
<table>
  ...
  <tr>
    <td>4</td>
    <td>Entorno de desarrollo y mecanismo de persistencia de datos</td>
  </tr>
  <tr>
    <td>5</td>
...
<table>
  ...
  <tr>
    <td>30/10/2026</td>
    <td>Unidad 2: Aplicaciones de escritorio con interfaz gráfica y persistencia de datos</td>
    <td>Aplicación de escritorio por capas con interfaz gráfica y persistencia de datos</td>
    <td>Evaluación del producto</td>
    <td>20%</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>20/11/2026</td>
    <td>Unidad 3: Proyecto Integrador de Aplicación de Escritorio</td>
    <td>Sistema orientado a objetos integrado para un proceso de negocio</td>
    <td>Evaluación del producto</td>
    <td>30%</td>
  </tr>
  <tr>
...
1. Horstmann, C. S. (2024). *Core Java, Volume I: Fundamentals* (13th ed.). Pearson.

2. Sierra, K., Bates, B., & Gee, T. (2022). *Head First Java* (3rd ed.). O'Reilly Media.

3. Khononov, V. (2021). *Learning Domain-Driven Design: Aligning Software Architecture and Business Strategy*. O'Reilly Media.

4. Ford, N., Richards, M., Sadalage, P., & Dehghani, Z. (2021). *Software Architecture: The Hard Parts*. O'Reilly Media.

5. Chin, S., Vos, J., & Weaver, J. (2024). *The Definitive Guide to Modern Java Clients with JavaFX: Cross-Platform Mobile and Cloud Development* (3rd ed.). Apress. ISBN 979-8-8688-0997-2.

6. Fernández-Marín, M. Á., & González-Tolmo, D. (2026). *Fundamentos del Diseño Orientado a Objetos en Ingeniería de Software: Desarrollo en Java como base para la formación investigativa*. Editorial UMET. [https://editorial.umet.edu.ec/fundamentos-del-diseno-orientado-a-objetos-en-ingenieria-de-software-desarrollo-en-java-como-base-para-la-formacion-investigativa/](https://editorial.umet.edu.ec/fundamentos-del-diseno-orientado-a-objetos-en-ingenieria-de-software-desarrollo-en-java-como-base-para-la-formacion-investigativa/)

7. Reina Valera. (1960). *La Santa Biblia*. Sociedades Bíblicas Unidas.

### Complementaria (Fuentes secundarias)

1. Levano, D., & Cerdán, F. (2023). *Manual de Programación Orientada a Objetos*. Lima, Perú.

2. Martín, A., (2018). *JAVA Curso práctico de formación*. Colombia: Alfaomega. 277 p.

3. López, B. (2016). *Curso de programación orientada a objetos en C# .NET*. España: RA-MA/Alfaomega. 437 p.

4. Sznajdleder, P. (2016). *Java a fondo: Curso de programación* (2.ª ed.). Argentina: Alfaomega. 452 p.

5. Sznajdleder, P. (2017). *Programación Orientada a Objetos y Estructura de Datos a Fondo*. Madrid: Alfaomega. 328 p.

6. Blasco, F. (2019). *Programación Orientada a Objetos en Java*. Madrid: Ra-Ma. 341 p.

7. Guardati, S. (2015). *Estructuras de Datos Básicas: Programación orientada a objetos con Java*. España: Alfaomega. 410 p.

8. Machacuay, M. (2021). *Tesis: SCRUM y KANBAN para la implementación de un Sistema de Información Transaccional en la mejora del monitoreo del proceso de Investigación Formativa en la Facultad de Ingeniería y Arquitectura de la Universidad Peruana Unión*. Universidad Peruana Unión.
