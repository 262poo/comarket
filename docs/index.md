...
| S4 | **Herencia y polimorfismo:**<br>Herencia con entidades usando `extends`, clase base, subclases, sobrescritura de métodos, polimorfismo con interface e `implements`, separación de responsabilidades | Entidades con herencia y contrato polimórfico con dos implementaciones |
