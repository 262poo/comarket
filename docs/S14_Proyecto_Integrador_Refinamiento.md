...
Producto refinado, validado y con evidencia de preparación o generacion de ejecutable nativo.

### 1.4 Motivación de la sesión

Un producto no solo debe funciónar una vez. Debe ser comprensible, estable, presentable y ejecutable en otro equipo.
