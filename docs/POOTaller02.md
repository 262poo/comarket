# Taller POO 02 - Construir el proyecto de escritorio U2 con JavaFX, Maven y SQLite

Este taller guia la construccion inicial del proyecto de la Unidad 2 en `comarket-desk`. El objetivo es pasar del producto de consola de U1 a una aplicacion de escritorio con JavaFX, Maven, arquitectura por capas, DAO, JDBC y SQLite.
