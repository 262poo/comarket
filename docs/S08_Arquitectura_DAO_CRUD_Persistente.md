...
CRUD persistente de una entidad simple desde GUI, usando `ProductoServiceBD`, `ProductoDAO`, SQLite y validaciones básicas.
...
classDiagram
    ...
    ProductoServiceBD --> ProductoDAO : usa
